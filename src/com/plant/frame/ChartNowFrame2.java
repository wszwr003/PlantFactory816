 ...
 * 实时采集数据界面Frame
 */
public class ChartNowFrame2 extends JFrame{
	public ChartNowFrame2(int id,String chartContent,String title,String yaxisName) {
		try {
	    ...
	    ChartNowDataPanel2 cp = new ChartNowDataPanel2(id,chartContent, title, yaxisName);
		 this.add(cp);
