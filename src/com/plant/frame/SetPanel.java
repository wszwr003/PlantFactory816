...
public class SetPanel extends JPanel{
			...
			public void actionPerformed(ActionEvent arg0) {
				if (!warnFlag) {
					...
					for (int i = 0; i < 6; i++) {
						...
						NodeJPanel.node_SET.get(i).co2_jButton.setEnabled(false);
						NodeJPanel.node_SET.get(i).co2_jButton2.setEnabled(false);
						NodeJPanel.node_SET.get(i).feng_jButton.setEnabled(false);
						NodeJPanel.node_SET.get(i).feng_jButton2.setEnabled(false);
						NodeJPanel.node_SET.get(i).temp_jButton.setEnabled(false);
						NodeJPanel.node_SET.get(i).temp_jButton2.setEnabled(false);
						NodeJPanel.node_SET.get(i).video_jButton.setEnabled(false);
					}
					...
					warnFlag = false;
					for (int i = 0; i < 6; i++) {
						NodeJPanel.node_SET.get(i).co2_jButton.setEnabled(true);
						NodeJPanel.node_SET.get(i).co2_jButton2.setEnabled(true);
						NodeJPanel.node_SET.get(i).feng_jButton.setEnabled(true);
						NodeJPanel.node_SET.get(i).feng_jButton2.setEnabled(true);
						NodeJPanel.node_SET.get(i).temp_jButton.setEnabled(true);
						NodeJPanel.node_SET.get(i).temp_jButton2.setEnabled(true);
						NodeJPanel.node_SET.get(i).video_jButton.setEnabled(true);
					}
	...
	class Time extends Thread{
		...
		public void run() {
			...
			if (TimerMinute.getCurrentTime().equals(sdf.format(spFrom.getValue()))) {
				PCAsServer.relayControl(1,(char)0x01,(char)0x02,(char)0x02);
			}
			if(TimerMinute.getCurrentTime().equals(sdf.format(spTo.getValue()))){
				PCAsServer.relayControl(1,(char)0x00,(char)0x02,(char)0x02);
			}
			if(TimerMinute.getCurrentTime().equals(sdf.format(spTo.getValue()))){
				PCAsServer.relayControl(1,(char)0x02,(char)0x02,(char)0x01);
			}
			if(TimerMinute.getCurrentTime().equals(sdf.format(spTo.getValue()))){
				PCAsServer.relayControl(1,(char)0x02,(char)0x02,(char)0x00);
			}
			}
		}
	}
...
//				Toolkit.getDefaultToolkit().beep();
				...
				if (Float.parseFloat(tempAlarmLow.getText())>Float.parseFloat(NodeJPanel.node_SET.get(0).temp_jTextField.getText())
						||Float.parseFloat(tempAlarmHigh.getText())<Float.parseFloat(NodeJPanel.node_SET.get(0).temp_jTextField.getText())) {
				...
				if (Float.parseFloat(co2AlarmLow.getText())>Float.parseFloat(NodeJPanel.node_SET.get(0).co2_jTextField.getText())
						||Float.parseFloat(co2AlarmHigh.getText())<Float.parseFloat(NodeJPanel.node_SET.get(0).co2_jTextField.getText()) 
						) {
	...
	class Set extends Thread{
		public void run() {
			while(true){
				if (Float.parseFloat(temp.getText())<Float.parseFloat(NodeJPanel.node_SET.get(0).temp_jTextField.getText())) {
					//温度上限
					PCAsServer.relayControl(1,(char)0x00,(char)0x02,(char)0x02);
				}
				else if(Float.parseFloat(humi.getText())<Float.parseFloat(NodeJPanel.node_SET.get(0).humi_jTextField.getText())){
					PCAsServer.relayControl(1,(char)0x02,(char)0x02,(char)0x00);
				}
				else if(Float.parseFloat(co2.getText())<Float.parseFloat(NodeJPanel.node_SET.get(0).co2_jTextField.getText())){
					PCAsServer.relayControl(1,(char)0x02,(char)0x00,(char)0x02);
				}
				else if(Float.parseFloat(temp_2.getText())>Float.parseFloat(NodeJPanel.node_SET.get(0).temp_jTextField.getText())){
					PCAsServer.relayControl(1,(char)0x01,(char)0x02,(char)0x02);	
				}
				else if(Float.parseFloat(humi_2.getText())>Float.parseFloat(NodeJPanel.node_SET.get(0).humi_jTextField.getText())){
					PCAsServer.relayControl(1,(char)0x02,(char)0x02,(char)0x01);
				}
				else if(Float.parseFloat(co2_2.getText())>Float.parseFloat(NodeJPanel.node_SET.get(0).co2_jTextField.getText())){
					PCAsServer.relayControl(1,(char)0x02,(char)0x01,(char)0x02);
				}
//				PCAsServer.relayControl(1,(char)0x00,(char)0x02,(char)0x02);
				try {
					Thread.sleep(1000);
