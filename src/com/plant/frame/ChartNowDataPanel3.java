...
public class ChartNowDataPanel3 extends ChartPanel implements Runnable
{
    ...
    public ChartNowDataPanel3(int id,String chartContent,String title,String yaxisName)
    {
