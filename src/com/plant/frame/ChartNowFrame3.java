 ...
 * 实时采集数据界面Frame
 */
public class ChartNowFrame3 extends JFrame{
	public ChartNowFrame3(int id,String chartContent,String title,String yaxisName) {
		try {
	    ...
	    ChartNowDataPanel3 cp = new ChartNowDataPanel3(id,chartContent, title, yaxisName);
		 this.add(cp);
